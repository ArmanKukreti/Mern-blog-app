  ...
  return (
    <div className="privacy" ref={container}>
      <section class="privacy__container">
        ...
        <h5>Last updated: June 01, 2024</h5>
        <p>
        ...
        <h3 style={{marginBottom: '1rem'}}>Interpretation & Definition</h3>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to The Crypto Trades, the
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to The Crypto Trades.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to The Crypto Trades, accessible
              from{" "}
              <a
                href="https://thecryptotrades.com"
                rel="noreferrer"
                target="_blank"
              >
                https://thecryptotrades.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 style={{marginBottom: '1rem'}}>Collecting and Using Your Personal Data</h2>
        <h3 style={{marginBottom: '1rem'}}>Types of Data Collected</h3>
        <h4 style={{marginBottom: '1rem'}}>Personal Data</h4>
        <p>
        ...
        <h3 style={{marginTop: '1rem'}}>Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 style={{marginBottom: '1rem'}}>Disclosure of Your Personal Data</h3>
        ...
        <h3 style={{marginTop: '1rem'}}>Security of Your Personal Data</h3>
        <p>
        ...
        <ul>
          <li>
            <p>By email: inquiry@thecryptotrades.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://thecryptotrades.com/contact"
                rel="noreferrer"
                target="_blank"
              >
                https://thecryptotrades.com/contact
              </a>
            </p>
          </li>
        </ul>
